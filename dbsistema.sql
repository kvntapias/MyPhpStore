...
-- Tiempo de generación: 25-08-2018 a las 20:40:15
...
(1, 1, '4343', 'Cocacola', 33, 'rika cocacolaxd', '1535169986.jpg', 0);
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `nombre` varchar(100) NOT NULL,
  `tipo_documento` varchar(20) NOT NULL COMMENT '	',
